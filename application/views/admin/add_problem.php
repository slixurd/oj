    ...
    <form class="add-problem-form" action="<?php echo site_url('admin/problem/add_problem') ?>" method="post">
        <div>
            ...
            <div class="row">
                ...
                <input id="title" class="necessary" type="text" name="title" />
            </div>
             <div class="row">
            ...
            <div class="row">
                <div class="append">
                    ...
                    <input id="time-limit" class="necessary" type="text" name="time-limit" />
                    <span class="add-on">ms</span>
                </div>
                <div class="append">
                    <span class="tip text-right">内存限制：</span>
                    <input id="memory-limit" class="necessary" type="text" name="memory-limit" />
